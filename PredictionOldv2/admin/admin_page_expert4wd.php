...
<html>
<head>
    <title>Expert 4WD</title>
    <link rel="stylesheet" type="text/css" href="admin.css">
    <link rel="icon" href="data:, ">
</head>
<body>
    <div class="divcenter">
        <h2>Expert 4WD DRIVERS</h2>
...
<div class="divcenter">
    ...
    fetch('admin_display_expert4wd.php')
    ...
    document.getElementById('add-driver-form').addEventListener('submit', function(event) {
        ...
        fetch('admin_insert_expert4wd.php', {
            method: 'POST',
            body: formData
        })
        .then(response => {
    ...
    if (event.target.classList.contains('update-button')) {
        ...
        fetch(`admin_update_expert4wd.php?id=${driverId}&active=${isChecked ? 1 : 0}`, {
            method: 'GET'
        })
        .then(response => {
            if (!response.ok) {
